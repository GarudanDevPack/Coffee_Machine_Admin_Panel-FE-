...
import { fetchAlertType, deleteAlertType } from '../../../../actions/types/alertTypeAction'

import AlertTypeDataTableMui from '../../../../components/tblcomponents/categories/AlertTypeTableWithFilter'
import Swal from 'sweetalert2'
import { useDispatch } from 'react-redux'
import AddAlertTypeModal from '../../../modal/AddAlertTypeModal'

/**
 * author Anushka Isuru Lakmal
 * created on 24-01-2025-15h-08m
 * copyright 2025
*/
...
const AlertType = () => {
  ...
  const [dataLength, setdataLength] = useState(null)
    ...
    const getData = async () => {
      try {
        const result = await dispatch(fetchAlertType())
    ...
    const handleDelete = async (id) => {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            await dispatch(deleteAlertType(id))
        ...
        <CCardHeader>
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="d-flex align-items-center">
              ...
              <AddAlertTypeModal visible={isModalVisible} onClose={() => setIsModalVisible(false)} 
                editData={editData}
              addOREdit={addOREdit}
                />
            </div>
